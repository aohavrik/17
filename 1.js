...
// let splise = arrs.splice(0, 2)
// console.log(splise);
// let splise2 = arrs.splice(0, 2, -3, 3)
// console.log(splise2);
// let splise3 = arrs.splice(-2, 2)
// console.log(splise3);
...
// let ob = obarr1.concat(obarr2)
// console.log(ob);

//Дана некоторая строка. Найдите позицию первого нуля в строке.
const first_str = "12340567089";
const firstIndex = first_str.indexOf('0');
console.log('Позиція першого нуля', firstIndex + 1);
...
for (let i = 1; i <= 1000; i++) {
    ...
    if (str.length >= 2) {
        const numa1 = parseInt(str[0]);
        const nama2 = parseInt(str[1]);
        if (numa1 + nama2 === 5) {
            console.log(i);
        }
    }
...
const arrdel = [1, 2, 3, 4, 5, 3, 6, 3];
let toDel = 3;
let filtArray = arrdel.filter(i => i !== toDel);
console.log("Массивпісля видалення:", filtArray);
//Дан некоторый массив, например, вот такой:
...
const leng = Math.floor(aar.length / 2);
const sum123 = aar.slice(0, length).reduce((sum, num) => sum + num, 0);

console.log("Сумма половини масива", sum123);